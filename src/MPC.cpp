...
// Set cost factors here for later tuning?
int cost_cte_factor = 3200;
int cost_epsi_factor = 520;  
int cost_v_factor = 1;
int cost_current_delta_factor = 1;
int cost_diff_delta_factor = 180;
...
class FG_eval {
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
	...
	// multiply squared devation by 'cost factors' to adjust contribution 
	for (int i = 0; i < N; i++) {
	...
	// Set initial state
	// add 1 to each of the starting values since cost is at fg[0]
	...
	// Set predicted states at other timesteps 
	...
	for (int i = 0; i < N - 1; i++) {
		...
		// Find the differences between actual and predicted states
